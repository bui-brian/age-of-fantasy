...
func _ready() -> void:
	...
	player_tower_top_button.pivot_offset = player_tower_top_button.size / 2
	...
	player_tower_bot_button.pivot_offset = player_tower_bot_button.size / 2
	...
	player_tower_top_button.mouse_exited.connect(_on_top_hover_exited)
	...
	player_tower_mid_button.mouse_exited.connect(_on_mid_hover_exited)
	...
	player_tower_bot_button.mouse_exited.connect(_on_bot_hover_exited)
